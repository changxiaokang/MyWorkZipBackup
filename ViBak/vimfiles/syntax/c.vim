...
"============================================================
"source ~/vimfiles/syntax/win_date_types.vim
hi link __function Function 

syn match __function display /\h\+\w*\s*(/me=e-1
syn match __function display /\[\]\s*(/me=e-1

syn match __operator display /[-+%=?:,]/
syn match __operator display /->\|\./
syn match __operator display /[!<>]=\=/
syn match __operator display /==/
syn match __operator display /\(&\||\|\^\|<<\|>>\)=\=/
...
syn match __operator display /&&\|||/
syn match __operator display /\(&&\|||\)=/
syn match __operator display /[\*/]/ contains=TOP

hi __operator guifg=grey
"hi __operator guifg=#3EFFE2
"============================================================
